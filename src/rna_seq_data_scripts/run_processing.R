run_processing <- function() {
  ...
  # # Optionally: Filter genes and transcripts using GeneCards database.
  # #             This step was implemented in submitted paper and does improve
  # #             the predictive performance.
  # source(paste(dir, "filter_rna_seq_gene_cards.R", sep = ""))
  # files <- list(genes = 
  ...
  # filter_using_gene_cards(data_dir, files, gene_cards_file)
